function MenuEditor(e, t) {
		...
		l = {
			...
			listOptions: {
				...
				opener: {
					...
					openerClass: 'btn btn-success btn-sm mx-2'
				},
	...
	function u() {
		var e = $('<div>').addClass('btn-group float-right mx-2'),
		...
		(this.add = function() {
			...
			var t = u(),
				...
				o = $('<div>')
					...
					.append(t),
				r = $('<li>').data(e)
			r.addClass('list-group-item pl-0').append(o),
				s.append(r),
				MenuEditor.updateButtons(s),
				d()
		}),
				...
				var n = (function e(t, l) {
					...
					return (
						$.each(t, function(t, s) {
							...
							var a = $('<li>').addClass('list-group-item pl-0')
							a.data(i)
		...
		function b(t, s) {
			if (
				...
				if (
					...
					return void r.css('display', 'none')
				o.length ? o.prepend(r) : (l.first().after(r), r.wrap(a)), d.oEl && L(s)
			}
			r.css('display', 'block'),
		...
		function g(t, s, l) {
			if (
				...
				if (
					...
					return void r.css('display', 'none')
				i.length ? i.prepend(r) : (o.first().after(r), r.wrap(a)), d.oEl && L(s)
			} else {
				if (s.prev('#sortableListsPlaceholder').length)
					return void r.css('display', 'none')
				s.before(r)
