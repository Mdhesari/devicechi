                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route("admin.payments.add") }}" method="POST" role="form">
                        ...
                        <div class="card-body">
                            ...
                            <!-- select -->
                            <div class="form-group">
                                <label for="brands-search">@lang(' Choose Brand ')</label>

                                <x-auto-complete-search :options="$brands" :single="true" id="brands-search" name="brand_id" :route="route('admin.ads.brands.search')" placeholder="{{__(' Choose Brand ')}}" :defaults="old('brand_id')">
                            ...
                            <!-- select -->
                            <div class="form-group">
                                <label for="cities-search">@lang(' Choose City ')</label>

                                <x-auto-complete-search :options="$cities" :single="true" id="cities-search" name="city_id" :route="route('admin.ads.cities.search')" placeholder="{{__(' Choose City ')}}" :defaults="old('city_id')">
                                </x-auto-complete-search>
