    ...
    */
    ...
    'demo' => [
        'warning' => [
            ...
            'desc' => 'آگهی شما هنوز منتشر نشده است و پس از تایید شما و سپس تایید تیم پشتیبانی ما منتشر خواهد شد. شما میتوانید با استفاده از دکمه های مربوطه که در سمت پایین وسط قرار داده شده، آگهی را ویرایش، حذف و یا برای انتشار در زمانی دیگر پیش نویس کنید.'
        ],
    ],
    ...
    'form' => [
        ...
        'label' => [
            ...
            'multicard' => 'دستگاه من چند سیم کارت را پشتیبانی میکند.',
        ],
        'placeholder' => [
