		...
		<b-form-group class="mt-2">
			...
			>
				<b-form-input
					...
					:type="
						input_data.type.data.input ? input_data.type.data.input : 'text'
					"
			...
			<b-button-group v-if="input_data.type">
				...
				<b-button @click="HideContactInput" variant="link" class="text-danger">
					<b-icon icon="x-circle-fill" class="vertical-middle"></b-icon>
				</b-button>
			</b-button-group>
		</b-form-group>
